...
export const CATALOGUE_COMPANIES: CatalogueCompany[] = [
  ...
  { key: "amazon", name: "Amazon", kind: "product", location: "Bengaluru", logo: "/images/companies/amazon.png", salaryFactor: 1.3,
  ...
  { key: "flipkart", name: "Flipkart", kind: "product", location: "Bengaluru", logo: "/images/companies/flipkart.png", salaryFactor: 1.15,
  ...
  { key: "meta", name: "Meta", kind: "product", location: "Hyderabad", logo: "/images/companies/meta.png", salaryFactor: 1.45,
  ...
  { key: "ibm", name: "IBM", kind: "services", location: "Bengaluru", logo: "/images/companies/ibm.svg", salaryFactor: 1.05,
  ...
  { key: "microsoft", name: "Microsoft", kind: "product", location: "Hyderabad", logo: "/images/companies/microsoft.png", salaryFactor: 1.4,
  ...
  { key: "tcs", name: "Tata Consultancy Services", kind: "services", location: "Pune", logo: "/images/companies/tcs.png", salaryFactor: 0.85,
  ...
  { key: "cognizant", name: "Cognizant", kind: "services", location: "Chennai", logo: "/images/companies/cognizant.png", salaryFactor: 0.9,
  ...
  { key: "accenture", name: "Accenture", kind: "services", location: "Mumbai", logo: "/images/companies/accenture.png", salaryFactor: 1.0,
  ...
  { key: "infosys", name: "Infosys", kind: "services", location: "Pune", logo: "/images/companies/infosys.png", salaryFactor: 0.9,
  ...
  { key: "wipro", name: "Wipro", kind: "services", location: "Bengaluru", logo: "/images/companies/wipro.svg", salaryFactor: 0.9,
  ...
  { key: "hcltech", name: "HCLTech", kind: "services", location: "Delhi NCR", logo: "/images/companies/hcltech.svg", salaryFactor: 0.95,
  ...
  { key: "techmahindra", name: "Tech Mahindra", kind: "services", location: "Pune", logo: "/images/companies/techmahindra.svg", salaryFactor: 0.85,
  ...
  { key: "ltm", name: "LTM Limited", kind: "services", location: "Mumbai", logo: "/images/companies/ltm.png", salaryFactor: 0.95,
  ...
  { key: "capgemini", name: "Capgemini", kind: "services", location: "Mumbai", logo: "/images/companies/capgemini.svg", salaryFactor: 1.0,
  ...
  { key: "mphasis", name: "Mphasis", kind: "services", location: "Bengaluru", logo: "/images/companies/mphasis.png", salaryFactor: 0.95,
  ...
  { key: "persistent", name: "Persistent Systems", kind: "services", location: "Pune", logo: "/images/companies/persistent.svg", salaryFactor: 1.0,
  ...
  { key: "coforge", name: "Coforge", kind: "services", location: "Delhi NCR", logo: "/images/companies/coforge.png", salaryFactor: 0.9,
  ...
  { key: "zensar", name: "Zensar Technologies", kind: "services", location: "Pune", logo: "/images/companies/zensar.svg", salaryFactor: 0.85,
  ...
  // --- Consumer internet, fintech and SaaS ---
  { key: "zerodha", name: "Zerodha", kind: "newEconomy", location: "Bengaluru", logo: "/images/companies/zerodha.svg", salaryFactor: 1.15,
  ...
  { key: "razorpay", name: "Razorpay", kind: "newEconomy", location: "Bengaluru", logo: "/images/companies/razorpay.svg", salaryFactor: 1.25,
  ...
  { key: "phonepe", name: "PhonePe", kind: "newEconomy", location: "Bengaluru", logo: "/images/companies/phonepe.svg", salaryFactor: 1.3,
  ...
  { key: "groww", name: "Groww", kind: "newEconomy", location: "Bengaluru", logo: "/images/companies/groww.png", salaryFactor: 1.2,
  ...
  { key: "swiggy", name: "Swiggy", kind: "newEconomy", location: "Bengaluru", logo: "/images/companies/swiggy.png", salaryFactor: 1.2,
  ...
  { key: "eternal", name: "Eternal", kind: "newEconomy", location: "Delhi NCR", logo: "/images/companies/eternal.svg", salaryFactor: 1.2,
  ...
  { key: "meesho", name: "Meesho", kind: "newEconomy", location: "Bengaluru", logo: "/images/companies/meesho.png", salaryFactor: 1.15,
  ...
  { key: "zepto", name: "Zepto", kind: "newEconomy", location: "Bengaluru", logo: "/images/companies/zepto.svg", salaryFactor: 1.15,
  ...
  { key: "freshworks", name: "Freshworks", kind: "newEconomy", location: "Chennai", logo: "/images/companies/freshworks.svg", salaryFactor: 1.1,
